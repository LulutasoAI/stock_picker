    ...
    def Get_data(self,run_mode=0):
        if run_mode ==0:
            sidlist = ["MMM", "AXP", "CAT","CVX","CSCO","KO","DOW","XOM","GS","HD","IBM","INTC","JNJ","JPM","MCD","MRK","MSFT","PFE","NKE","PG","TRV",
                    "UNH","VZ","WMT","WBA","DIS","^N225",  "^GSPC", "TM",  "BA", "PYPL", "TWTR", "V" , 
                    'AMD',  'GOOGL', 'GOOG',  'AMZN', 'AAPL', 'AMAT',  'BRK.B',  'CSCO',  'KO', 'ENPH',   'GRMN', 'GM',
                    ]
        elif run_mode == 1: 
